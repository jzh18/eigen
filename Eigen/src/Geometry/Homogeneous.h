...
class Homogeneous : public MatrixBase<Homogeneous<MatrixType, Direction_> >, internal::no_assignment_operator {
 public:
  ...
  EIGEN_DEVICE_FUNC constexpr inline Index rows() const EIGEN_NOEXCEPT {
    return m_matrix.rows() + (int(Direction) == Vertical ? 1 : 0);
  }
  EIGEN_DEVICE_FUNC constexpr inline Index cols() const EIGEN_NOEXCEPT {
...
struct homogeneous_left_product_impl<Homogeneous<MatrixType, Vertical>, Lhs>
  ...
  EIGEN_DEVICE_FUNC constexpr inline Index rows() const EIGEN_NOEXCEPT { return m_lhs.rows(); }
  EIGEN_DEVICE_FUNC constexpr inline Index cols() const EIGEN_NOEXCEPT { return m_rhs.cols(); }
