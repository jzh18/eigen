...
/** \internal */
struct CacheSizes {
  constexpr CacheSizes() : m_l1(-1), m_l2(-1), m_l3(-1) {
...
/** \internal */
inline constexpr void manage_caching_sizes(Action action, std::ptrdiff_t* l1, std::ptrdiff_t* l2, std::ptrdiff_t* l3) {
 ...
 * \sa setCpuCacheSize */
inline constexpr std::ptrdiff_t l1CacheSize() {
  std::ptrdiff_t l1, l2, l3;
 ...
 * \sa setCpuCacheSize */
inline constexpr std::ptrdiff_t l2CacheSize() {
  std::ptrdiff_t l1, l2, l3;
  internal::manage_caching_sizes(GetAction, &l1, &l2, &l3);
  return l2;
}
 ...
 * \sa setCpuCacheSize */
inline constexpr std::ptrdiff_t l3CacheSize() {
  std::ptrdiff_t l1, l2, l3;
  internal::manage_caching_sizes(GetAction, &l1, &l2, &l3);
  return l3;
}
...
inline constexpr void setCpuCacheSizes(std::ptrdiff_t l1, std::ptrdiff_t l2, std::ptrdiff_t l3) {
