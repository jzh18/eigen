...
class Array : public PlainObjectBase<Array<Scalar_, Rows_, Cols_, Options_, MaxRows_, MaxCols_>> {
 ...
 public:
  ...
  /** \internal */
  EIGEN_DEVICE_FUNC constexpr Array(internal::constructor_without_unaligned_array_assert)
  ...
  constexpr EIGEN_DEVICE_FUNC Array& operator=(Array&& other) EIGEN_NOEXCEPT_IF(std::is_nothrow_move_assignable<Scalar>::value) {
