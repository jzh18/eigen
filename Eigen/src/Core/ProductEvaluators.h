...
struct product_evaluator<Product<Lhs, Rhs, LazyProduct>, ProductTag, DenseShape, DenseShape>
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr const PacketType packet(Index row, Index col) const {
    PacketType res;
  ...
  template <int LoadMode, typename PacketType>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr const PacketType packet(Index index) const {
    const Index row = (RowsAtCompileTime == 1 || MaxRowsAtCompileTime == 1) ? 0 : index;
    const Index col = (RowsAtCompileTime == 1 || MaxRowsAtCompileTime == 1) ? index : 0;
...
struct product_evaluator<Product<Lhs, Rhs, ProductKind>, ProductTag, DiagonalShape, DenseShape>
  ...
  template <int LoadMode, typename PacketType>
  EIGEN_STRONG_INLINE constexpr PacketType packet(Index idx) const {
