...
template <typename Packet>
EIGEN_STRONG_INLINE EIGEN_DEVICE_FUNC constexpr Packet pfrexp_generic_get_biased_exponent(const Packet& p);
...
template <typename Packet>
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS constexpr Packet generic_patan(const Packet& x);
...
template <typename Packet>
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS constexpr Packet pasin_float(const Packet& x);

/** \internal \returns acos(x) for single precision float */
template <typename Packet>
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS constexpr Packet pacos_float(const Packet& x);

/** \internal \returns tanh(x) for single precision float */
template <typename Packet>
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS constexpr Packet ptanh_float(const Packet& x);

/** \internal \returns tanh(x) for double precision float */
template <typename Packet>
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS constexpr Packet ptanh_double(const Packet& x);
...
template <typename Packet>
EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS constexpr Packet pexp_complex(const Packet& x);
...
#define EIGEN_PACKET_FUNCTION(METHOD, SCALAR, PACKET)                                                       \
  template <>                                                                                               \
  EIGEN_STRONG_INLINE EIGEN_DEVICE_FUNC EIGEN_UNUSED constexpr PACKET p##METHOD<PACKET>(const PACKET& _x) { \
