...
class FullPivLU : public SolverBase<FullPivLU<MatrixType_, PermutationIndex_> > {
 public:
  ...
  EIGEN_DEVICE_FUNC inline constexpr Index rows() const EIGEN_NOEXCEPT { return m_lu.rows(); }
  EIGEN_DEVICE_FUNC inline constexpr Index cols() const EIGEN_NOEXCEPT { return m_lu.cols(); }
