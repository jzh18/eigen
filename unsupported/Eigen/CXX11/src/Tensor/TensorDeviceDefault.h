...
struct DefaultDevice {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr void memcpy(void* dst, const void* src, size_t n) const {
    ::memcpy(dst, src, n);
  }
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr size_t firstLevelCacheSize() const {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr size_t lastLevelCacheSize() const {
#if !defined(EIGEN_GPU_COMPILE_PHASE) && !defined(SYCL_DEVICE_ONLY)
