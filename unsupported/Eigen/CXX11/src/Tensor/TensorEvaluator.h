...
struct TensorEvaluator {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr PacketReturnType packet(Index index) const {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr void writePacket(Index index, const PacketReturnType& x) const {
...
struct TensorEvaluator<const TensorSelectOp<IfArgType, ThenArgType, ElseArgType>, Device> {
  ...
  EIGEN_DEVICE_FUNC constexpr PacketReturnType packet(Index index) const {
